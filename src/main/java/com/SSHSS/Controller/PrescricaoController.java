...
//
//    @PutMapping("/{id}")
//    public ResponseEntity<Prescricao> atualizarPrescricao(@PathVariable UUID id, @RequestBody Prescricao prescricaoAtualizada) {
...
//
//    @DeleteMapping("/{id}")
//    public ResponseEntity<Void> deletarPrescricao(@PathVariable UUID id) {
